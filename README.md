...
2. **Electricity Consumption Carbon Emissions Calculation**

   Data:
   - [US Energy Information Administration (EIA) - Daily Region Sub-Ba Data](https://www.eia.gov/opendata/browser/electricity/rto/daily-region-sub-ba-data)
   
   Process:
   - Monitor daily electricity generation in US subregions.
   
3. **CO2 Emissions Aggregate and CO2 Coefficients**
